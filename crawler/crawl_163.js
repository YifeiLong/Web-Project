...
// var seedURL = 'https://ent.163.com/special/star_news/';
// var seedURL = 'https://ent.163.com/';
var seedURL = 'https://ent.163.com/special/ssyx/';
// var seedURL = 'https://ent.163.com/music/';
// var seedURL = 'https://ent.163.com/tv/';
...
var author_format = "$('meta[name=\"article:author\"]').eq(0).attr(\"content\")"; //编辑
var content_format = "$('meta[name=\"description\"]').eq(0).attr(\"content\")"; //文章
var url_reg = /\/article/; //用于匹配主页面中的新闻子页面的正则表达式
