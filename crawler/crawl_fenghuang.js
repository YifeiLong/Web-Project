...
var source_name = "凤凰网娱乐";
var myEncoding = "utf-8";
// var seedURL = 'https://ent.ifeng.com/';
// var seedURL = 'https://ent.ifeng.com/star/';
// var seedURL = 'https://ent.ifeng.com/movie/';
// var seedURL = 'https://ent.ifeng.com/tv/';
var seedURL = 'https://ent.ifeng.com/music/';

var seedURL_format = "$('a')";
var keywords_format = "$('meta[name=\"keywords\"]').eq(0).attr(\"content\")";
var title_format = "$('meta[property=\"og:title\"]').eq(0).attr(\"content\")"; // 标题
var date_format = "$('meta[name=\"og:time \"]').eq(0).attr(\"content\")"; // 日期
var author_format = "$('meta[name=\"og:category\"]').eq(0).attr(\"content\")"; //编辑
var content_format = "$('meta[name=\"description\"]').eq(0).attr(\"content\")"; //文章
var url_reg = /\/ent\.ifeng\.com\/c/; //用于匹配主页面中的新闻子页面的正则表达式
